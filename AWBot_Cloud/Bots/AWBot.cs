...
using AWBot_Cloud.Helpers;
using AWBot_Cloud.Models;
using AWBot_Cloud.Services;
using Microsoft.Bot.Builder;
using Microsoft.Bot.Schema;

namespace AWBot_Cloud.Bots
{
    public class AWBot : ActivityHandler, IBot
    {
        ...
        public AWBot(ConversationState conversationState, UserState userState)
        {
            _conversationState = conversationState;
            _userState = userState;
        }
